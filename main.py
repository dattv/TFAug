...
def main(input_dir=None, output_dir=None):
    ...
    tf_pooling = tf_image_pooling(img)
    with tf.Session() as sess:
        ...
        for f in file_img:
            ...
            cv2.imwrite(os.path.join(output_dir, "pooling" + "_" + str(i) + ".jpg"), pooling)
            i += 1
